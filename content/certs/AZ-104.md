...
> [!NOTE]
> **CẬP NHẬT NỘI DUNG:** Microsoft đã lên lịch cập nhật nội dung cho kỳ thi AZ-104 (bản tiếng Anh) vào ngày **17/04/2026**. Các ứng viên nên kiểm tra lại Skills Measured chính thức sát ngày thi.
...
### Microsoft Entra Suite (Mới)
- **Microsoft Entra Private Access**: Giải pháp ZTNA (Zero Trust Network Access) thay thế VPN truyền thống để truy cập app nội bộ.
- **Microsoft Entra Internet Access**: Secure Web Gateway (SWG) bảo mật việc truy cập internet và các app SaaS.
...
### Hybrid & Multi-cloud (Mới)
- **Azure Arc**: Quản lý server, Kubernetes cluster và app chạy trên on-premise hoặc cloud khác (AWS, GCP) ngay từ giao diện Azure. Giúp áp dụng Azure Policy và RBAC lên tài nguyên ngoài Azure.
